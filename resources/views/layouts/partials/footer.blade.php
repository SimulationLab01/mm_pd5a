...
<!--                         <p class="social-login">
                        ...
                        <p class="fieldset">
                            <label class="image-replace cd-email" for="signin-email">使用者帳號</label>
                            <input class="full-width has-padding has-border" id="signin-email" type="text" placeholder="使用者帳號">
                            <span class="cd-error-message">Error message here!</span>
                        </p>

                        <p class="fieldset">
                            <label class="image-replace cd-password" for="signin-password">密碼</label>
                            <input class="full-width has-padding has-border" id="signin-password" type="password"  placeholder="密碼">
                            <a href="javascript:void(0);" class="hide-password">顯示</a>
                            <span class="cd-error-message">Error message here!</span>
                        </p>
